...
1. Check existing components: `git ls-files` filtered to your project's components directory
2. Check existing APIs: `git ls-files` filtered to your project's API directory
