          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-indigo-100">
                <Users className="w-5 h-5 text-[var(--vb-accent)]" />
              </div>
              <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {!showAddForm && (
                    <button
                      ...
                      className="px-3 py-1.5 bg-[var(--vb-accent)] text-white text-sm font-medium rounded-lg hover:bg-[var(--vb-accent-hover)] transition-colors flex items-center gap-1.5"
                    >
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[var(--vb-accent)] focus:border-[var(--vb-accent)] text-sm"
                    onKeyDown={(e) => {
                      if (e.key === 'Enter') {
                        handleAddPosition();
                      }
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-[var(--vb-accent)] text-white rounded-lg hover:bg-[var(--vb-accent-hover)] transition-colors disabled:opacity-50"
