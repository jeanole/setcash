        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 min-w-0 block px-3 py-2 text-sm border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-slate-900 placeholder-slate-400"
