            ...
            {usersLoading ? (
              ...
              <div className="flex flex-wrap items-center gap-3">
                <select
                  ...
                  className="block w-full sm:w-auto min-w-[200px] px-3 py-2 text-sm border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[var(--vb-accent)] focus:border-[var(--vb-accent)] text-slate-900 bg-white"
                ...
                <button
                  ...
                  className={cn(
                    'inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--vb-accent)] focus:ring-offset-2',
                    isDownloadingUserPdf
                      ? 'bg-[var(--vb-accent)] text-white cursor-not-allowed'
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className={cn(
                    'inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg border transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--vb-accent)] focus:ring-offset-2',
                    isDownloadingExcel
