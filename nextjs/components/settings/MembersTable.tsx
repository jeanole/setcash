      ...
      cell: (row) => {
        ...
        return (
          <select
            ...
            className="w-full px-2 py-1.5 text-sm border border-slate-300 rounded focus:outline-none focus:ring-2 focus:ring-[var(--vb-accent)] disabled:bg-slate-100 disabled:cursor-not-allowed"
          >
            {ROLES.map((role) => (
              <option
                key={role.value}
    ...
    },
    {
      ...
      cell: (row) => (
        <select
          ...
          className="w-full px-2 py-1.5 text-sm border border-slate-300 rounded focus:outline-none focus:ring-2 focus:ring-[var(--vb-accent)]"
        >
