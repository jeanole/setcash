            ...
            {editing?.id === category.id ? (
              <div className="flex-1 flex items-center gap-2">
                <input
                  ...
                  autoFocus
                  maxLength={100}
                  className="flex-1 px-2 py-1 text-sm border border-slate-300 rounded focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
                ...
                <input
                  ...
                  min={0}
                  step={0.01}
                  className="w-28 px-2 py-1 text-sm border border-slate-300 rounded focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
                  placeholder="Budget"
                />
                <button
                    ...
                    <button
                      ...
                      className={`text-left ${
                        isProtected(category.name)
                          ...
                          : 'cursor-pointer hover:text-[var(--accent)] font-medium text-slate-700'
                      }`}
                  ...
                  <button
                    ...
                    className={`text-sm ${
                      isProtected(category.name)
                        ...
                        : 'text-slate-600 hover:text-[var(--accent)] cursor-pointer'
                    }`}
                  >
        ...
        {isAdding ? (
          <form onSubmit={handleAddSubmit} className="flex items-center gap-2 px-4 py-3">
            <input
              ...
              maxLength={100}
              autoFocus
              className="flex-1 px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
            />
            <input
              type="number"
              ...
              min={0}
              step={0.01}
              className="w-28 px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
            />
            <button
              type="submit"
          ...
          <button
            ...
            className="flex items-center gap-2 w-full px-4 py-3 text-sm font-medium text-[var(--accent)] bg-indigo-50 rounded-lg border border-dashed border-indigo-200 hover:bg-indigo-100 transition-colors"
          >
