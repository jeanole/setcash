        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--vb-accent)] focus:border-[var(--vb-accent)]"
            />
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              maxLength={500}
              className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--vb-accent)] focus:border-[var(--vb-accent)] resize-none"
            />
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="flex items-center gap-2 px-4 py-2 bg-[var(--vb-accent)] text-white rounded-md font-medium hover:bg-[var(--vb-accent-hover)] disabled:opacity-50 transition-colors"
            >
