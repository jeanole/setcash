      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end pt-2">
          <button
            ...
            className="px-4 py-2 bg-[var(--vb-accent)] text-white rounded-md font-medium hover:bg-[var(--vb-accent-hover)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
