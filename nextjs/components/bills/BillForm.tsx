      ...
      <section className="bg-white rounded-xl border border-[var(--vb-card-border)] shadow-[var(--vb-shadow-sm)] p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-zinc-200 rounded-lg focus:ring-2 focus:ring-[var(--vb-accent)]/20 focus:border-[var(--vb-accent)] outline-none transition-colors font-mono-numbers"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-zinc-200 rounded-lg focus:ring-2 focus:ring-[var(--vb-accent)]/20 focus:border-[var(--vb-accent)] outline-none transition-colors bg-white"
            >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-zinc-200 rounded-lg focus:ring-2 focus:ring-[var(--vb-accent)]/20 focus:border-[var(--vb-accent)] outline-none transition-colors"
            />
          </div>
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 border border-zinc-200 rounded-lg focus:ring-2 focus:ring-[var(--vb-accent)]/20 focus:border-[var(--vb-accent)] outline-none transition-colors resize-y"
          />
        </div>
      </section>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 border border-zinc-200 rounded-lg focus:ring-2 focus:ring-[var(--vb-accent)]/20 focus:border-[var(--vb-accent)] outline-none transition-colors font-mono-numbers"
                placeholder="0.00"
              />
            </div>
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <CinematicButton>
          <button
            ...
            className={cn(
              'px-6 py-2 bg-[var(--vb-accent)] text-white font-medium rounded-lg transition-colors',
              isSubmitting || validationErrors.length > 0
                ? 'opacity-50 cursor-not-allowed'
                : 'hover:bg-[var(--vb-accent-hover)]'
            )}
          >
