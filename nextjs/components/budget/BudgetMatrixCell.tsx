...
export default function BudgetMatrixCell({
  ...
  if (isEditing) {
    return (
      <div className="p-2 bg-indigo-50 border-2 border-[var(--vb-accent)] rounded">
        <input
          ref={inputRef}
          type="number"
          value={editValue}
          ...
          step="0.01"
          autoFocus
          className="w-full px-2 py-1 text-sm border border-zinc-300 rounded focus:outline-none focus:ring-2 focus:ring-[var(--vb-accent)] font-mono-numbers"
        />
      </div>
    );
  }
