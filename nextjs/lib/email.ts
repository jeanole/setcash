                ...
                <tr>
                  <td style="padding:40px;">
                    ...
                    <div style="text-align:center;margin:32px 0;">
                      <a
                        href="${resetUrl}"
                        style="display:inline-block;background-color:var(--vb-accent);color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;padding:12px 32px;border-radius:8px;"
                      >
                        Reset Password
                      </a>
                    </div>
                    ...
                    <p style="color:#94a3b8;font-size:12px;margin:16px 0 0 0;word-break:break-all;">
                      ...
                      <a href="${resetUrl}" style="color:var(--vb-accent);">${resetUrl}</a>
                    </p>
                  </td>
                </tr>
                <!-- Footer -->
              ...
              <table width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;box-shadow:0 4px 24px rgba(0,0,0,0.06);overflow:hidden;">
                ...
                <tr>
                  <td style="padding:40px;">
                    ...
                    <p style="color:#94a3b8;font-size:12px;margin:16px 0 0 0;word-break:break-all;">
                      Or copy this link into your browser:<br />
                      <a href="${verifyUrl}" style="color:var(--vb-accent);">${verifyUrl}</a>
                    </p>
                  </td>
                </tr>
                <!-- Footer -->
              ...
              <table width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;box-shadow:0 4px 24px rgba(0,0,0,0.06);overflow:hidden;">
                ...
                <tr>
                  <td style="padding:40px;">
                    ...
                    <p style="color:#94a3b8;font-size:12px;margin:16px 0 0 0;word-break:break-all;">
                      Or copy this link into your browser:<br />
                      <a href="${inviteUrl}" style="color:var(--vb-accent);">${inviteUrl}</a>
                    </p>
                  </td>
                </tr>
                <!-- Footer -->
              ...
              <table width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;box-shadow:0 4px 24px rgba(0,0,0,0.06);overflow:hidden;">
                ...
                <tr>
                  <td style="padding:40px;">
                    ...
                    <p style="color:#94a3b8;font-size:12px;margin:16px 0 0 0;word-break:break-all;">
                      Or copy this link into your browser:<br />
                      <a href="${signupUrl}" style="color:var(--vb-accent);">${signupUrl}</a>
                    </p>
                  </td>
                </tr>
                <!-- Footer -->
